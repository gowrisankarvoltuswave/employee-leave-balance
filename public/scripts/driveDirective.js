...
app
    ...
    .directive('driveDirective', function () {
        return {
            restrict: 'E',
            ...
            link: function (scope, element, attrs) {
                ...
                var CLIENT_ID = '980818055652-40mtbld2vgtvmm07554lffh305c3qlrn.apps.googleusercontent.com';
                var API_KEY = 'AIzaSyDUZzRbv8DRWe1eVAe_C_eLCjG2A-s-9xg';
                var FOLDER_NAME = "";
                var FOLDER_ID = "1dm_go8DBC66GfZbgG7vkBsIM2vVOMJIq";
                ...
                $(document).ready(function () {
                    ...
                    $("#button-addfolder").click(function () {		//add folder
                        $("#transparent-wrapper").show();
                        $("#float-box").show();
                        $("#txtFolder").val("");
                    });
